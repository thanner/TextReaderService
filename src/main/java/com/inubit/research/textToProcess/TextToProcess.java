...
public class TextToProcess {
    ...
    private T2PStanfordWrapper f_stanford;
    ...
    private LaneSplitOffControler f_lsoControler = null;

    /**
     * Thanner
     *
     * @param stanfordWrapper
     */
    public TextToProcess(T2PStanfordWrapper stanfordWrapper) {
        f_stanford = stanfordWrapper;
    ...
    public TextToProcess(TextToProcessListener listener, TextModelControler tmControler, LaneSplitOffControler lsoControler) {
        ...
        f_stanford = new T2PStanfordWrapper(false);
    }
    ...
    public TextToProcess(TextToProcessListener listener) {
        f_listener = listener;
        f_stanford = new T2PStanfordWrapper();
    }

    public TextModelBuilder getF_builder() {
        return f_builder;
    }

    public TextModelControler getF_textModelControler() {
        return f_textModelControler;
    }
