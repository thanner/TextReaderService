...
public class SimpleGraph {
    ...
    public SimpleGraph(Set<Integer> vertices, Map<Integer, Set<Integer>> outgoingEdges, Map<Integer, Set<Integer>> incomingEdges, Map<Integer, String> labels, Set<Integer> functionVertices, Set<Integer> eventVertices, Set<Integer> connectorVertices) {
