...
public class GraphEditDistanceAllOptions extends DistanceAlgoAbstr implements DistanceAlgo {
    ...
    private void computeAllMappings() {
        ...
        unfinishedMappings.add(new UnfinishedMapping(sg1.getVertices(), sg2.getVertices()));
            ...
            if (uf.freeVertices1.isEmpty() || uf.freeVertices2.isEmpty()) {
                ...
                for (Integer f1 : uf.freeVertices1) {
                    for (Integer f2 : uf.freeVertices2) {
                        if (StringEditDistance.similarity(this.sg1.getLabel(f1), this.sg2.getLabel(f2)) >= ledcutoff) {
                            UnfinishedMapping newMapping = new UnfinishedMapping(uf.freeVertices1, uf.freeVertices2, uf.mapping);
    ...
    class UnfinishedMapping {
        ...
        public UnfinishedMapping(Set<Integer> freeVertices1, Set<Integer> freeVertices2, Set<TwoVertices> mapping) {
        ...
        public UnfinishedMapping(Set<Integer> freeVertices1, Set<Integer> freeVertices2) {
            this.freeVertices1 = new HashSet<Integer>(freeVertices1);
            this.freeVertices2 = new HashSet<Integer>(freeVertices2);
            this.mapping = new HashSet<TwoVertices>();
        }
        ...
        public int hashCode() {
            return this.freeVertices1.hashCode() +
                    this.freeVertices2.hashCode() +
                    this.mapping.hashCode();
        }
    }
}
