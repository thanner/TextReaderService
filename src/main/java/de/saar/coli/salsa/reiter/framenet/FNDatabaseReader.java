...
public class FNDatabaseReader extends DatabaseReader {
     ...
     *
     * @param fnhome   The main directory of FrameNet
     * @param validate If set to true, the class will validate the XML files before
     *                 loading them
     * @throws FileNotFoundException If the main FrameNet directory does not exist
     * @throws SecurityException     If the main FrameNet directory can not be read
     */
     ...
     *
     * @param frames     Location of the file frames.xml
     * @param frRelation Location of the file frRelation.xml
     * @param framesDiff Location of the file framesDiff.xml
     * @param semtypes   Location of the file semtypes.xml
     */
     ...
     *
     * @throws FileNotFoundException If the FrameNet database files can not be found.
     */
     ...
     */
    @SuppressWarnings("unchecked")
    protected int loadAllFrames(FrameNet fn) {
        try {
     ...
     *
     * @param node The node from the XML document.
     */
