...
public class Test {
   ...
   *  if (op.doPCFG && op.doDep && ! ExampleApp.useFastFactored).
   */
  ...
  public static void display() {
    String str = "ExampleApp parameters maxLength=" + maxLength + " preTag=" + preTag + " outputFormat=" + outputFormat + " outputFormatOptions=" + outputFormatOptions + " printAllBestParses=" + printAllBestParses;
