...
public class FastExactAutomatonMinimizer implements AutomatonMinimizer {
  ...
  public static void main(String[] args) {
    ...
    fa.addSequenceFlow(fa.getStartNode(),"1","a","");
    fa.addSequenceFlow(fa.getStartNode(),"2","b","");
    fa.addSequenceFlow(fa.getStartNode(),"3","c","");
    fa.addSequenceFlow("1","4","a","");
    fa.addSequenceFlow("2","4","a","");
    fa.addSequenceFlow("3","5","c","");
    fa.addSequenceFlow("4",fa.getEndNode(),"c","");
    fa.addSequenceFlow("5",fa.getEndNode(),"c","");
